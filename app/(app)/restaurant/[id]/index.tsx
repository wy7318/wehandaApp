...
export default function RestaurantDetails() {
  ...
  const handleActivityPress = (activityType: ActivityType) => {
    if (activityType === 'analytics') {
      router.push(`/restaurant/${id}/analytics`);
    } else if (activityType === 'dashboard') {
      router.push('/restaurant/dashboard');
    } else if (activityType === 'waitlist') {
      setShowAnalytics(true);
    } else if (activityType === 'reservations') {
      router.push('/restaurant/reservations');
    } else if (activityType === 'customers') {
      router.push(`/restaurant/${id}/customers`);
    } else {
